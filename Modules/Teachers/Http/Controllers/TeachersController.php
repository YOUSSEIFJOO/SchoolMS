                ...
                try{
                    ...
                    if($checkFounding > 0) {
                        ...
                        /** Start $data Variable **/
                             ...
                             **/
                            $data = AppHelper::StorePhotoIfFound($request, ["_token", "photo", "password"], "teachers");
                ...
                try {
                    ...
                    if($foundClass == $request->class_id_teachers && $foundSection == $request->section_id_teachers && $foundSubject == $request->subject_id_teachers) {
                        ...
                        /** Start $data Variable **/
                             ...
                             **/
                            $data = AppHelper::DeleteStorePhotoIfFound($this->teacher, $id, $request, ["_token", "photo", "password"], "teachers", "teachers");
