            ...
            <div class="col-md-3 p-0 pl-2">
                ...
                <a href="{{ route('employees.create') }}" class="text-decoration-none">
                    ...
                    <button class="btn btn-block btn-info text-light">
                            ...
                            <i class="fa fa-plus mr-2"></i> Add New Employee
                        ...
                        @foreach($employees as $index => $employee)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('employees.show', $employee->id) }}" class="text-light">
            ...
            <div class="pag-count">
                ...
                <div class="row m-0">
                    ...
                    <div class="col-sm-6 p-0 text-right">
                        ...
                        Showing 1 To {{ $paginationNumber }} Of {{ $employees->count() }} Entries
