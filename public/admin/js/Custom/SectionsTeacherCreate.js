    ...
    /** This Method For Get Related Sections When I Press On Class Select Box In Create View Of Teachers **/
    ...
    $(document).ready(function(){
        ...
        $("#class_id_teachers").on('change', function(e) {
            ...
            $.get('create/section_teachers?class_id=' + class_id , function(data) {
